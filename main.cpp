...
int main() {
    ...
    GLFWwindow *window = initInDefault(WIDTH, HEIGHT, "LearnOpenGL", nullptr, nullptr); // Windowed
    ...
    // Load font as face
    FT_Face face;
    if (FT_New_Face(ft, "../msyhl.ttc", 0, &face))
    ...
    //Load List of chinese Characters from 4E00-9FA5
    for(wchar_t wch = 0x4E00;wch != 0x9FA5;wch++){
        ...
        Characters.insert(std::pair<GLuint, Character>(wch, character));
    }
    ...
    while (!glfwWindowShouldClose(window)) {
        ...
        RenderText(shader, L"¹þ", tan(glfwGetTime())*25.0f + 25.0f, 25.0f, 1.0f, glm::vec3(0.5, 0.8f, 0.2f));
